 ...
 * подпись картинки, доступное имя у ByRole, содержимое в toHaveTextContent и хелперы карточек и
 * селектов. Формы, до которых селектор не достаёт (`*ByPlaceholderText`, `*ByTitle`,
 * `*ByDisplayValue`, `toHaveAccessibleName`), в тестах сейчас не встречаются; понадобится такая —
 ...
 */
const TEXT_QUERIES = '/^(get|find|query)(All)?By(Text|LabelText|AltText)$/';
