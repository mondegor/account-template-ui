...
export const limits = {
  ...
  /** Код подтверждения из сообщения: ровно 6 цифр — длина кода развёртывания внутри объявленного
   *  для звеньев EMAIL и PHONE диапазона 4..8. Верхнюю границу поле применяет жёстко, лишние
   *  цифры отбрасываются при вводе. */
  confirmCode: { min: 6, max: 6 },
  /** Новый емаил в форме его смены. */
  newEmail: { min: 7, max: 64 },
  /** Новый телефон в форме его установки/смены: границы строки, а не числа цифр — номер
   *  набирают с пробелами, скобками и дефисами. */
  newPhone: { min: 10, max: 32 },
} as const;
