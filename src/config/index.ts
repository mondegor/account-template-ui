...
export const limits = {
  ...
  secret: { min: 4, max: 32 },
  /** Пароль как второй фактор — форма его установки, где формат известен. Поле подтверждения
   *  (secret) проверяется своими границами: оно обслуживает несколько форматов разом, и сузить
   *  его до пароля нельзя. */
