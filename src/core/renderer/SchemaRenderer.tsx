 ...
 * `form` — спец-обработка (FormRenderer ставит контекст react-hook-form). Инвариант
 * безопасности: fail-closed на незарегистрированный тип (не рендерим произвольное), запрет
